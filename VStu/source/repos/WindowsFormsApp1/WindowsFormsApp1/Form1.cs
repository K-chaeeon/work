...
namespace WindowsFormsApp1
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            label1.Size = new Size(139, 84);

            label2.Text = num2.ToString();
            label2.AutoSize = false;
            label2.Size = new Size(139, 84);

            label3.Text = num3.ToString();
            label3.AutoSize = false;
            label3.Size = new Size(139, 84);

            label4.Text = num4.ToString();
            label4.AutoSize = false;
            label4.Size = new Size(139, 84);

            label5.Text = num5.ToString();
            label5.AutoSize = false;
            label5.Size = new Size(139, 84);

            label6.Text = num6.ToString();
            label6.AutoSize = false;
            label6.Size = new Size(139, 84);
